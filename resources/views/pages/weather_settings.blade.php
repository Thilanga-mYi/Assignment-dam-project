...
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form autocomplete="off" action="/weather_settings/enroll" method="POST"
                            id="form_records">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-md-6 p-0">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input value="{{ old('trans_start_location') }}"
                                                                type="text" name="trans_start_location"
                                                                id="trans_start_location" class="form-control"
                                                    ...
                                                    <div class="col-md-6 p-0">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input value="{{ old('trans_end_location') }}"
                                                                type="text" name="trans_end_location"
                                                                id="trans_end_location" class="form-control"
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea placeholder="Enter Remark .." class="form-control" name="trans_remark" id="trans_remark" cols="30"
                                                            rows="3">{{ old('trans_remark') }}
                                                        </textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input id="submitbtn" class="btn btn-success w-100"
    ...
    <script>
        ...
        //         window.location = "/weather_settings/change_status?id=" + id;
        //     });
        // }
